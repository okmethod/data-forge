...
--   接続先 census_population_prefecture_timeseries.parquet は既に県粒度なので、ここは素の射影のみ。
...
select
  ...
  population,
  data_status
from read_parquet('../../data/processed/census_population_prefecture_timeseries.parquet')
