...
select
  ...
  workers
from (
  select * from read_parquet('../../data/processed/census_occupation_major12_national_timeseries.parquet')
  union all
  select * from read_parquet('../../data/processed/census_occupation_major12_prefecture_timeseries.parquet')
)
