...
with m as (
  ...
  from read_json('../../data/processed/census_households_national_timeseries.meta.json')
  union all
  select title, provider, source, dataset_id, citation, 2 as ord
  from read_json('../../data/processed/census_households_prefecture_timeseries.meta.json')
),
d as (
