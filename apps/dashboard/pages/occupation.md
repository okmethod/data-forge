...
[産業](/industry) が「**どの産業で働いているか**」なら、職業は「**どんな仕事に就いているか**」の軸。  
主役は **職業別就業者数** と **職業構成比（＝各職業就業者数 ÷ 総数）**で、[人口ピラミッド](/pyramid) の高齢化と対にすると「**職業構成の転換（農林漁業 → 生産工程 → 事務・専門技術）**」が読める。  
