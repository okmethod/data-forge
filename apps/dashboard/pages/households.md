...
データセット: **世帯の種類別 世帯数・世帯人員** - 全国／都道府県は1960〜2020年（12回）、市区町村は1985〜2020年（合併畳み込み済み）

このページでは、人口とは別の基幹軸である**世帯**を、全国 → 都道府県 → 市区町村のスケールで見ていく。  
...
## 市区町村ミクロ：印西市の世帯数は35年で約4.4倍

市区町村粒度でしか描けないミクロの一例。
人口を増やし続ける**千葉県印西市**では、**一般世帯数が1985→2020年で約4.4倍**に膨らんだ。
...
<LineChart
  ...
  x=year
  y=households
  title="印西市 一般世帯数（合併畳み込み済み）"
  yFmt="#,##0"
  xType=category
/>

_※ 世帯数は市区町村でも1985年以降の全回で連続する。人口の伸びと重ねると世帯の細分化（核家族化・単身化）が読める——[印西市ケーススタディ](/inzai) を参照。_
