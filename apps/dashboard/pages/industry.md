...
このページでは、[労働力](/labor_force) に続く**就業構造**を、**「どの産業で働いているか」**の軸で、全国 → 都道府県のスケールで見ていく。  
主役は **産業別就業者数** と **産業構成比（＝各産業就業者数 ÷ 総数）**で、高齢化（[人口ピラミッド](/age_5year)）と対にすると「**産業構造の転換（製造業 → 医療・福祉）**」が読める。  
