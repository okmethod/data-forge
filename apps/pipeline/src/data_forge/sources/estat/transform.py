...
# 就業系の市区町村版（回次別）は男女別コードが 4 桁体系（0000/0010/0020）でマクロ SEX と別。
# industry/occupation/labor_force の市区町村 cleaner が共用（macro と同じ sex_code "0/1/2" へ寄せる）。
SEX_MUNI = {"0000": ("0", "総数"), "0010": ("1", "男"), "0020": ("2", "女")}
