...
年ごとの構造の違い（すべて同一の出力スキーマへ写像する）:
    - 1985(0003412414)/1990(0003412415)/1995(0003412416): 同型の「年齢3区分,男女別人口及び年齢別割合」表。
...
def _clean_age3class_table(tidy: pl.DataFrame) -> pl.DataFrame:
    """昭和60年(0003412414)/平成2年(0003412415)/平成7年(0003412416) の同型表 → 男女別総人口。
    ...
    公表値との一致: 1985=121,048,923 / 1990=123,611,167 / 1995=125,570,246。
    """
...
# 1985/1990/1995 は同型（全国行なし・年齢3区分×男女）→ 共通 cleaner を流用。
